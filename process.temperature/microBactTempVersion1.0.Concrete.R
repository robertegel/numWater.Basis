...

{
  ...
  #png(file="../plots/microBactTempVersion0.8.Concrete.plot1.png",
  ...
  mtext("Integration Model v0.8 (concrete)", side = 3, line = -2, outer = TRUE)
 # dev.off()
  
  #png(file="../plots/microBactTempVersion0.8.Concrete.plot2.png",
  #    width=2000, height=1500, pointsize = 24)
  par(mfrow = c(2,2))
  plot(simDays, out[, "Q_out"], type = "l", ylab = "Q_out", ylim = c(0, max(out[, "Q_out"])))
  plot(simDays, out[, "c"], type = "l", ylab = "concentration bacteria")
  plot(simDays, out[, "c"]*out[, "h"], type = "l", ylab = "total amount bacteria")
  plot(simDays, out[, "T_water"], type = "l", ylab = "T_water")
...
plot(simDays, out[, "T_water"], type = "l", ylab = "T_water", xlim = c(0.540,0.542))
plot(simDays, out[, "h"], type = "l", ylab = "h", xlim = c(0.540,0.542))
plot(simDays, out[, "Q_out"], type = "l", ylab = "Q_out", xlim = c(0.540,0.542))
