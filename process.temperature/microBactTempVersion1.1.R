...
{
  version <- "microBactTempVersion1.1"
  ...
  # png(file=paste0("../plots/", version, ".plot1.png"),
  #     width=2000, height=1500, pointsize = 24)
  par(mfrow = c(2,2))
  ...
  mtext(paste0(version," plot1"), side = 3, line = -2, outer = TRUE)
  # dev.off()
}

{  
  # png(file=paste0("../plots/", version, ".plot2.png"),
  #     width=2000, height=1500, pointsize = 24)
  par(mfrow = c(2,2))
  plot(simDays, data[, "h"], type = "l", ylab = "h", ylim = c(0, max(out[, "h"])))
  plot(simDays, data[, "c"], type = "l", ylab = "concentration bacteria")
  ...
  mtext(paste0(version, " plot2"), side = 3, line = -2, outer = TRUE)
  # dev.off()
}

{
  # png(file=paste0("../plots/", version, ".plot3.png"),
      # width=2000, height=1500, pointsize = 24)
  par(mfrow = c(2,2))
  plot(simDays, data$h, type="l", ylab="", xlab = "simDays")
  par(new = TRUE)
  plot(simDays, data$Q_out, type = "l", axes = FALSE, bty = "n", xlab = "", ylab = "", col = "red")
  axis(side=4, at = pretty(range(data$Q_out)), col="red")
  legend("topright", c("h", "Q_out"), lty=c(1,1), lwd=c(2.5,2.5), col=c("black", "red"))
  
  plot(simDays, data$h, type="l", ylab="", xlab = "simDays")
  par(new = TRUE)
  plot(simDays, data$T_water, type = "l", axes = FALSE, bty = "n", xlab = "", ylab = "", col = "red")
  axis(side=4, at = pretty(range(data$T_water)), col="red")
  legend("topright", c("h", "T_water"), lty=c(1,1), lwd=c(2.5,2.5), col=c("black", "red"))
  
  plot(simDays, data$h, type="l", ylab="", xlab = "simDays")
  par(new = TRUE)
  plot(simDays, data$c, type = "l", axes = FALSE, bty = "n", xlab = "", ylab = "", col = "red")
  axis(side=4, at = pretty(range(data$c)), col="red")
  legend("topright", c("h", "c"), lty=c(1,1), lwd=c(2.5,2.5), col=c("black", "red"))
  
  plot(simDays, data$T_water, type="l", ylab="", xlab = "simDays")
  par(new = TRUE)
  plot(simDays, data$c, type = "l", axes = FALSE, bty = "n", xlab = "", ylab = "", col = "red")
  axis(side=4, at = pretty(range(data$c)), col="red")
  legend("topright", c("T_water", "c"), lty=c(1,1), lwd=c(2.5,2.5), col=c("black", "red"))
  
  mtext(paste0(version, " plot3 (interaction)"), side = 3, line = -2, outer = TRUE)
  # dev.off()
}
