...

{
  ...
  # png(file="../plots/microBactTempVersion0.8.Polyethylen.plot1.png",
  ...
  mtext("Integration Model v0.8 (Polyethylen)", side = 3, line = -2, outer = TRUE)
  #dev.off()
  
  # png(file="../plots/microBactTempVersion0.8.Polyethylen.plot2.png",
  #     width=2000, height=1500, pointsize = 24)
  par(mfrow = c(2,2))
  plot(simDays, out[, "Q_out"], type = "l", ylab = "Q_out", ylim = c(0, max(out[, "Q_out"])))
  plot(simDays, out[, "c"], type = "l", ylab = "concentration bacteria")
