...
version <- "allModelsVersion1.7.variation.h_0"
...
## -plots---------------------------------------------------------------------------------------------------
{
  ...
  plotgird <- plot_grid(
    ggplot(microOutData, aes(simDays, n_Bottles,  group=h_0)) +
      geom_line(size = 0.5, aes(colour = h_0)) +
      xlab("simulation time in days"),
    ggplot(macroOutData, aes(time, V, group=h_0)) +
      geom_line(size = 0.5, aes(colour = h_0)) +
      xlab("simulation time in days"),
    ggplot(microOutData, aes(simDays, T_water, group=h_0)) +
      geom_line(size = 0.5, aes(colour = h_0)) +
      xlab("simulation time in days"),
    ggplot(microOutData, aes(simDays, c, group=h_0)) +
      geom_line(size = 0.5, aes(colour = h_0)) +
      xlab("simulation time in days")
    )
  title <- ggdraw() +
